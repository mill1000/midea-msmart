...
_DISCHARGE_PIPE_TEMP_TABLE = (
    ...
    24, 25, 26, 27, 27, 28, 29, 30, 30, 31, 32, 32, 33, 34, 34, 35, 36, 36, 37, 37,
    38, 39, 39, 40, 40, 41, 41, 42, 42, 43, 44, 44, 45, 45, 46, 46, 47, 47, 48, 48,
    49, 49, 50, 50, 51, 51, 52, 52, 53, 53, 54, 54, 55, 55, 56, 56, 56, 57, 57, 58,
    58, 59, 59, 60, 60, 61, 61, 62, 62, 63, 63, 63, 64, 64, 65, 65, 66, 66, 67, 67,
    68, 68, 69, 69, 69, 70, 70, 71, 71, 72, 72, 73, 73, 74, 74, 75, 75, 76, 76, 76,
    77, 77, 78, 78, 79, 79, 80, 80, 81, 81, 82, 82, 83, 83, 84, 84, 85, 85, 86, 86,
    87, 87, 88, 88, 89, 90, 90, 91, 91, 92, 92, 93, 93, 94, 95, 95, 96, 96, 97, 98,
    98, 99, 99, 100, 101, 101, 102, 103, 103, 104, 105, 105, 106, 107, 107, 108,
    109, 109, 110, 111, 112, 112, 113, 114, 115, 116, 116, 117, 118, 119, 120, 121,
    122, 123, 124, 125, 126, 127, 128, 129, 130, 135, 136, 137, 138, 140, 141, 142,
    144, 145, 147, 148, 150, 152, 153, 155, 157, 159, 161, 163, 165, 168, 170, 173,
...
class Group1Response(Response):
    ...
    def __init__(self, payload: memoryview) -> None:
        ...
        self.outdoor_voltage: Optional[int] = None
        self.outdoor_total_current: Optional[int] = None
        self.indoor_operating_mode: Optional[int] = None
    ...
    def _parse(self, payload: memoryview) -> None:
        ...
        self.outdoor_total_current = payload[7] * 4
        self.outdoor_voltage = payload[8]
        self.indoor_operating_mode = payload[9]
        ...
        # TP: mapped from lookup table
        self.discharge_pipe_temperature = _DISCHARGE_PIPE_TEMP_TABLE[payload[14]]
